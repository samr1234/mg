...
const StripCounter = () => {
  ...
  return (
    ...
    <div className="sm:flex block mx-auto w-[20rem]  justify-around  mt-12 pb-12 ">
      ...
      <div className=" mb-10 border-8 shadow-lg shadow-indigo-500/50 border-indigo-500/50 rounded-full py-12 px-12 text-2xl bg-gradient-to-r ">
        <CountUp start={0} end={250} duration={4}>
          {({ countUpRef, start }) => (
            <div className="flex flex-col items-center">
              <span className="text-indigo-500/50 font-bold" ref={countUpRef}>250</span>
              <button className="" onload={start}>
      ...
      <div className=" mb-10 border-8 shadow-lg border-cyan-500/50 shadow-cyan-500/50 rounded-full py-12 px-12 text-2xl">
