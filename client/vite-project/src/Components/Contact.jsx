...
e.preventDefault();
  ...
  return (
    <div id="contact" className="sm:h-screen mt-[17rem] bg-gradient-to-r from-[#f0f2f0] via-white to-[#F0EEFF]">
      <h1 className="flex justify-around text-5xl pt-[5rem] pb-[5rem] font-bold text-blue-500">Contact Us</h1>
